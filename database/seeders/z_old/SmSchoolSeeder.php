    ...
    public function run()
    {
        ...
        SmSchool::factory()->times(1)->create()->each(
            function ($school) {
                    ...
                    $classes=SmClass::factory()->times(2)->create($school_academic)->each(function ($class) use ($sections, $school_academic, $school, $subjects, $teacher_id, $rooms, $academic_year) {
                        ...
                        foreach ($class_sections as $data) {
                            ...
                            for ($i = 1; $i <= 5; $i++) {                                
                                User::factory()->times(1)->create([
                                    'role_id' =>2,
                                    'email'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@edu.shamiit.com', 
                                    'username'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@edu.shamiit.com',
                                    'school_id' =>$school->id,
                                ]);
                                User::factory()->times(1)->create([
                                    'role_id' =>3,
                                    'email'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@edu.shamiit.com', 
                                    'username'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@edu.shamiit.com',
                                    'school_id' =>$school->id,
                                ]);
                ...
                $s->link_href1  = 'https://edu.shamiit.com';
        
                $s->link_label2 = 'SHAMIIT Home';
                $s->link_href2  = 'https://edu.shamiit.com/home';
        
                $s->link_label3 = 'Business';
                $s->link_href3  = 'https://edu.shamiit.com';
        
                $s->link_label4 = 'link_label4';
                $s->link_href4  = 'https://edu.shamiit.com';
        
                $s->link_label5 = 'link_label5';
                $s->link_href5  = 'https://edu.shamiit.com';
        
                $s->link_label6 = 'link_label6';
                $s->link_href6  = 'https://edu.shamiit.com';
        
                $s->link_label7 = 'link_label7';
                $s->link_href7  = 'https://edu.shamiit.com';
        
                $s->link_label8 = 'link_label8';
                $s->link_href8  = 'https://edu.shamiit.com';
        
                $s->link_label9  = 'Home';
                $s->link_href9   = 'https://edu.shamiit.com/home';
        
                $s->link_label10 = 'About';
                $s->link_href10  = 'https://edu.shamiit.com/about';
        
        
                $s->link_label11 = 'Contact';
                $s->link_href11  = 'https://edu.shamiit.com/contact';
        
                $s->link_label12 = 'link_label12';
                $s->link_href12  = 'https://edu.shamiit.com';
        
                $s->link_label13 = 'link_label13';
                $s->link_href13  = 'https://edu.shamiit.com';
        
                $s->link_label14 = 'link_label14';
                $s->link_href14  = 'https://edu.shamiit.com';
        
                $s->link_label15 = 'link_label15';
                $s->link_href15  = 'https://edu.shamiit.com';
        
                $s->link_label16 = 'link_label16';
                $s->link_href16  = 'https://edu.shamiit.com';
                $s->school_id = $school->id; 
                $s->save();
