...
<style>
    ...
    .QA_section.check_box_table .QA_table .table.student-profile-exam-table thead tr th::after{
        top: 8px
    }
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="leaves">
                            <div class="white-box">
                                <div class="row mt-30">
                                    <div class="col-lg-12">
                                        <x-table>
                                            <table id="table_id" class="table student-profile-exam-table" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
