                                 ...
                                 <tr>
                                         ...
                                         <td>
                                             @if(is_null($module->purchase_code) && (!file_exists($is_module_available)))
                                                 <a class="primary-btn fix-gr-bg nowrap" href="{{$module->addon_url}}"
                                                                     ...
                                                                     <div class="modal-dialog modal-dialog-centered">
                                                                         <div class="modal-content">
                                                                             ...
                                                                             <div class="modal-body text-left">
                                                                                 ...
                                                                                 <div class="row mt-40">
                                                                                     <div class="col-lg-12 text-center">
                                                                                         <button class="primary-btn fix-gr-bg nowrap" type="submit">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="mt-40 d-flex justify-content-between">
                                        ...
                                        <input class="primary-btn fix-gr-bg nowrap submit" type="submit" value="@lang('common.submit')">
                                    </div>
                                </div>
