                                                        ...
                                                        <div class="primary_file_uploader">
                                                            ...
                                                            <button class="" type="button">
                                                                <label class="primary-btn small fix-gr-bg"
                                                                    for="header_image">{{ __('common.browse') }}</label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label d-flex"
                                                    for="">@lang('common.details')<span class="text-danger"> *</span>
                                                    @if (moduleStatusCheck('AiContent'))
                                                        @include('aicontent::inc.button')
                                                    @endif
                                                </label>
                                                <textarea
                                                    class="generated-text primary_input_field summer_note form-control{{ $errors->has('details') ? ' is-invalid' : '' }}"
