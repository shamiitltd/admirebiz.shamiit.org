                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    <label class="primary_input_label d-flex"> @lang('common.description') <span
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    <label class="primary_input_label d-flex"> @lang('front_settings.main_description') <span
                                                            class="text-danger"> *</span>
                                                        @if (moduleStatusCheck('AiContent'))
                                                            @include('aicontent::inc.button')
                                                        @endif
                                                    ...
                                                    <textarea class="primary_input_field form-control" cols="0" rows="5" name="main_description"
                                                        id="main_description">{{ isset($update) ? ($SmCoursePage != '' ? $SmCoursePage->main_description : '') : '' }}</textarea>
                                                ...
                                                <div class="primary_file_uploader">
                                                    ...
                                                    <button class="" type="button">
                                                        <label class="primary-btn small fix-gr-bg"
                                                            for="browseFile">{{ __('common.browse') }}
                                                            @lang('front_settings.image')(1420px*450px)</label>
