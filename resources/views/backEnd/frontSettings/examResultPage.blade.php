                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    <label class="primary_input_label d-flex"
                                                        for="">@lang('common.description') <span class="text-danger"> *</span>
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    <label class="primary_input_label d-flex"
                                                        for="">@lang('front_settings.main_description')
                                                    ...
                                                    <textarea class="primary_input_field form-control" cols="0" rows="5" name="main_description"
                                                        id="main_description">{{ isset($update) ? ($exam_page != '' ? $exam_page->main_description : '') : '' }}</textarea>
                                    ...
                                    <div class="mt-20">
                                        <section class="container box-1420">
                                            <div class="banner-area"
                                                style="background: linear-gradient(0deg, rgba(124, 50, 255, 0.6), rgba(199, 56, 216, 0.6)), url({{ $exam_page->image != '' ? $exam_page->image : '../img/client/common-banner1.jpg' }}) no-repeat center;background-size: 100%">
                                                <div class="banner-inner">
                                                    <div class="banner-content">
                                                        ...
                                                        <a class="primary-btn fix-gr-bg semi-large"
                                                            href="{{ $exam_page->button_url }}">{{ $exam_page->button_text }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </section>
                                            ...
                                            <div class="col-md-6">
                                                <div class="academic-item">
                                                    <div class="academic-img">
                                                        <img class="img-fluid" src="{{ asset($exam_page->main_image) }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
