    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="primary_input">
                <label class="primary_input_label" for="">@lang('system_settings.subject/title')
                </label>
                ...
                <div class="primary_input mt-20">
                    <label class="primary_input_label d-flex"
                        for="">@lang('system_settings.email_body')
                ...
                <div class="primary_input mt-20">
                    <label class="primary_input_label d-flex" for="">@lang('system_settings.sms_text')
                        @if (moduleStatusCheck('AiContent'))
                            @include('aicontent::inc.button')
                        @endif
                    </label>
                ...
                <div class="row mt-40">
                    <div class="col-lg-12 text-center">
                        <button type="submit" class="primary-btn fix-gr-bg text-nowrap updateNotificationModal"
                            data-toggle="tooltip">
